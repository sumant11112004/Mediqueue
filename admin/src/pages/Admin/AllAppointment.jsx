...
const AllAppointment = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      <p className='mb-3 text-lg font-large'>All Appointments</p>
      <div className='bg-white border rounded border-gray-200 text-md max-h-[80vh] min-h-[70vh] overflow-y-scroll no-scrollbar'>
        <div className='hidden sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] grid-flow-col py-3 px-6 border-b border-gray-200'>
          <p>#</p>
          <p>Patient</p>
          <p>Age</p>
          <p>Date & Time</p>
